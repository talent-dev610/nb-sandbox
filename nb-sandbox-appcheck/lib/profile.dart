...
class ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> editProfile(ProfileModel profileModel) async {
    profileCollection.doc(widget.id).update(profileModel.toMap()).then((value) {
      setState(() {
        print("=============");
  ...
  Future<ProfileModel?> getData(String? id) async {
    profileCollection.doc(id).get().then((DocumentSnapshot doc) {
      setState(() {
        profileModel = ProfileModel.fromMap(
            Map<String, dynamic>.from(doc.data() as Map<dynamic, dynamic>));
        studentGroupValue = profileModel.studentFlag;

        print("==========>" + studentGroupValue!);
        SpecialtyDropdownValue = profileModel.specialty;
        ShiftLength = profileModel.shiftLength;
        ScheduleType = profileModel.scheduleType;
        DegreeDropdownValue = profileModel.degree;
        checkedLicenseList = profileModel.licenseList;
        ...
        birthdayDate = DateTime.fromMillisecondsSinceEpoch(
            int.parse(profileModel.birthday!));
        for (int i = 0; i < LicenseList.length; i++) {
          if (checkedLicenseList!.contains(LicenseList[i]))
            licenseCheckFlag[i] = true;
        }
        checkedCertificationsList = profileModel.certificationsList;
        for (int i = 0; i < LicenseList.length; i++) {
          if (checkedCertificationsList!.contains(CertificationsList[i]))
            certificationsCheckFlag[i] = true;
        }
        for (int i = 0; i < profileModel.hospitalList!.length; i++) {
          hospitalControllerList.add(TextEditingController());
        }
        for (int i = 0; i < profileModel.hospitalList!.length; i++) {
          hospitalControllerList[i].text = profileModel.hospitalList![i];
        }
        List<String> workStatus = ["Yes", "No"];
        jobCount = profileModel.workStatusList!.length;
        for (int i = 0; i < profileModel.workStatusList!.length; i++) {
          workStatusList.add(workStatus);
        }
        workGroupValueList = profileModel.workStatusList;
        for (int i = 0; i < profileModel.startDateList!.length; i++) {
          print(profileModel.startDateList![i]);
          if (profileModel.startDateList![i] == "") {
            DateTime? temp;
            startDateList.add(temp);
          } else {
            startDateList.add(DateTime.fromMillisecondsSinceEpoch(
                int.parse(profileModel.startDateList![i])));
          }
        }
        for (int i = 0; i < profileModel.endDateList!.length; i++) {
          if (profileModel.endDateList![i] == "") {
            DateTime? temp;
            endDateList.add(temp);
          } else {
            endDateList.add(DateTime.fromMillisecondsSinceEpoch(
                int.parse(profileModel.endDateList![i])));
          }
        }
        _isInAsyncCall = false;
      });
  ...
  Future<void> deleteProfile(ProfileModel profileModel) async {
    profileCollection.doc(profileModel.id).delete().then((value) {
      setState(() {
        Navigator.push(
          context,
          MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //         PopupMenuItem(
      //           child: ListTile(
      //             leading: Icon(FontAwesomeIcons.penToSquare, color: Colors.blue),
      //             title: Text("Edit"),
      //             onTap: () {
      //               setState(() {
      //                 editFlag = true;
                  ...
                  Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText: profileModel.userEmail,
                            focusedBorder: OutlineInputBorder(
                                borderSide: BorderSide(color: Colors.grey),
                                borderRadius: BorderRadius.circular(10)),
                            enabledBorder: OutlineInputBorder(
                  ...
                  /*Container(
                    ...
                    child: DateTimeField(
                      decoration: InputDecoration(
                          ...
                          hintText: profileModel.birthday == null
                              ? ""
                          ...
                          Container(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  enabled: editFlag ? true : false,
                                  fillColor: Colors.white,
                                  hintText: profileModel.firstName,
                                  focusedBorder: OutlineInputBorder(
                                      borderSide:
                          ...
                          Container(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  enabled: editFlag ? true : false,
                                  fillColor: Colors.white,
                                  hintText: profileModel.lastName,
                                  focusedBorder: OutlineInputBorder(
                                      borderSide:
                                          BorderSide(color: Colors.grey),
                                      borderRadius: BorderRadius.circular(10)),
                                              ...
                                              Container(
                                                ...
                                                child: TextField(
                                                  ...
                                                  decoration: InputDecoration(
                                                      ...
                                                      // hintText: profileModel.hospitalName == "" ? "Hospital" : profileModel.hospitalName,
                                                      focusedBorder: OutlineInputBorder(
                                                          borderSide: BorderSide(
                                                              color:
                                                                  Colors.grey),
                                                      ...
                                                      /* Container(
                                                        ...
                                                        child: DateTimeField(
                                                          decoration: InputDecoration(
                                                              ...
                                                              prefixIcon: Icon(Icons
                                                                  .date_range),
                                                              hintText: startDateList[position] == null
                                                                  ? ""
                                                                  : DateFormat('y/M/d').format(
                                                                      startDateList[
                                                                          position]!),
                                                              ...
                                                              enabledBorder: OutlineInputBorder(
                                                                  borderSide:
                                                                      BorderSide(color: Colors.grey),
                                                                  borderRadius: BorderRadius.circular(10)),
                                                              errorBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.grey), borderRadius: BorderRadius.circular(10)),
                                                              disabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.grey), borderRadius: BorderRadius.circular(10))),
                                                          onSaved: (val) =>
                                                              setState(() =>
                                                                  startDateList[
                                                            ...
                                                            /*Container(
                                                              ...
                                                              child:
                                                                ...
                                                                decoration: InputDecoration(
                                                                    ...
                                                                    prefixIcon: Icon(Icons
                                                                        .date_range),
                                                                    hintText: endDateList[position] == null
                                                                        ? ""
                                                                        : DateFormat('y/M/d').format(endDateList[
                                                                            position]!),
                                                                    focusedBorder: OutlineInputBorder(
                                                                        borderSide: BorderSide(
                                                                            color: Colors
                  ...
                  GestureDetector(
                    ...
                    onTap: () async {
                      if (editFlag) {
                        if (userNameController.text == "") {
                        ...
                        } else if (DateTime.now().year - birthdayDate!.year <
                            18) {
                          ...
                          List<String> endDate = [];
                          for (int i = 0;
                              i < hospitalControllerList.length;
                              i++) {
                          ...
                          profileModel = ProfileModel(
                              ...
                              birthday: birthdayDate!.millisecondsSinceEpoch
                                  .toString(),
                              firstName: firstNameController.text,
                              lastName: lastNameController.text,
                              graduationDate: graduationDate == null
                                  ? ""
                                  : graduationDate!.millisecondsSinceEpoch
                                      .toString(),
